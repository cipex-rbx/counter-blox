...
mousedown = true-- counter blox https://cipex.solutions
...
mouse.Move:Connect(function()-- counter blox https://cipex.solutions
...
local teambasedstatus = st1_3:Clone()-- counter blox https://cipex.solutions
...
Name.TextSize = 14
Name.TextWrapped = true-- counter blox https://cipex.solutions
...
if aimbothider == true then-- counter blox https://cipex.solutions
aimbothiderbox.Text = "Speed :"..tostring(aimbothiderspeed).." on"
else
aimbothiderbox.Text = "Speed :"..tostring(aimbothiderspeed).." off"
end
...
if not e then
local fold = Instance.new("Folder", espforlder)-- counter blox https://cipex.solutions
fold.Name = plr.Name
...
urmom.Transparency = wallhack_esp_transparency
urmom.Parent = fold
end-- counter blox https://cipex.solutions
end
plr.Character.Humanoid.Died:Connect(function()
fold:Destroy()
end)
...
TeamBased = true-- counter blox https://cipex.solutions
teambasedstatus.Text = "Team Based: "..tostring(TeamBased)
end
...
aimatpart = nil
canaimat = false
delay(1.1, function()-- counter blox https://cipex.solutions
canaimat = true
end)
end
end
...
local lastpart = nil-- counter blox https://cipex.solutions
